...
INSERT INTO kg_user (`gmt_create`,`gmt_modified`,`user_no`,`token`,`last_token`,`salt`,`gmt_last_token_disable`,`dw_access_id`,`dw_access_key`,`real_name`,`nick_name`,`email`,`domain_account`,`mobile`,`wx_account`,`config`) VALUES(now(),now(),'openspg','075Df6275475a739',null,'Ktu4O',null,null,'18fa96c2dade75441850913685a41064f4c9472db2a400f44850aa076d746c51','openspg','openspg',null,'openspg',null,null,'{"useCurrentLanguage":"zh-CN"}');
