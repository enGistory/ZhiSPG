...
INSERT INTO kg_user (`gmt_create`,`gmt_modified`,`user_no`,`token`,`last_token`,`salt`,`gmt_last_token_disable`,`dw_access_id`,`dw_access_key`,`real_name`,`nick_name`,`email`,`domain_account`,`mobile`,`wx_account`,`config`) VALUES(now(),now(),'admin','Admin075Df627547',null,'Adm01',null,null,'ba5344759d4ed45e16bf13657b4675599ea9031201e854029e86b559a004d2aa','admin','admin',null,'admin',null,null,'{"useCurrentLanguage":"zh-CN"}');
...
INSERT INTO kg_resource_permission (`gmt_create`,`gmt_modified`,`user_no`,`resource_id`,`role_id`,`resource_tag`,`status`,`expire_date`) VALUES(now(),now(),'admin',0,1,'PLATFORM','1',null);
